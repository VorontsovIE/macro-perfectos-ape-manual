...
% \DefineProgramInvokationCommand{\EvalAlignment}{macroape.EvalAlignment}
...
% PERFECTOS-APE~---\\{\small Predicting Regulatory Functional Effect of SNPs by Approximate \pvalue\ Estimation}\\
-- User Manual --
}
\maketitle
...
\section{Formal math}
  ...
  \input{sections/options/pcm-ppm-pwm-conversion-format}


\section{Source code}
package is distributed as a standalone package. It's source code is distributed under GNU GPL and DO WHAT THE FUCK YOU WANT TO PUBLIC LICENSE licenses.

One can download lastest version of source code from github: \urldecorated{https://github.com/prijutme4ty/macro-perfectos-ape}
