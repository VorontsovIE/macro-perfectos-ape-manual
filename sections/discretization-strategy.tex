...
We use the default discretization level of $10^4$ to perform calculation accuracy up to
four significant digits for single-PWM tools from APE toolbox. The straightforward discretization by rounding up to
