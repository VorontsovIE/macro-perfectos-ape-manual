...
To find similar PWMs using a particular \pvalue\ level one should use the \cmdoption{"-p"}~option. Default \pvalue\ is 0.0005.

\exampleof{}
\ScanCollection{motifs/KLF4\_f2.pat\\ ./selex/\\ -p 0.001\\ -c 0.06 --precise 0.1}
% \outputheader[Output (STDOUT)]
