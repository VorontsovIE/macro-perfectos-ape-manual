...
Helen Touzet \urldecorated{http://bioinfo.lifl.fr/TFM/TFMpvalue/} but with the fixed predefined discretization level (see section~\ref{discretization-strategy}).
...
greater than requested (lower boundary for \pvalue). For details see \cmdoption{--boundary} option description in section~\ref{advanced-options}.
