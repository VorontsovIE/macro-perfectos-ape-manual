...
The \PcmToPwm\ conversion is described in a [PCM to PWM math] section. It's possible to manually specify a fixed pseudocount $a$ with \cmdoption{--pseudocount \requiredarg{a}} option. When not specified, pseudocount is derived from alignment weight $W$: $a =\ln(W)$.
