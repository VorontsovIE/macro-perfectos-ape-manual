...
The \PcmToPwm\ conversion is described in a section \ref{pcm2pwm-algorithm}. It's possible to manually specify a fixed pseudocount $a$ with \cmdoption{--pseudocount \requiredarg{a}} option. When not specified, pseudocount is derived from alignment weight $W$: $a =\ln(W)$.
